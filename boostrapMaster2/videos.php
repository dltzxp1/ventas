        ...
        <div id="wrapper">
            ...
            <section id="featured"> 
                <div class="aligncenter"> 
                    <div class="btn-group">
                        <button class="btn btn-red">Otavalo hace 65 años atras</button>
                    </div>
                    <div id="twitter-wrapper"> 
                        <iframe width="640" height="360" src="//www.youtube.com/embed/Dsy-YRB1V58?feature=player_detailpage" frameborder="0" allowfullscreen>
                        </iframe>
                    </div>
                </div>
                <div class="aligncenter"> 
                    <div class="btn-group">
                        <button class="btn btn-red">Intyrayme Maya Inka Guadalajara Tlaquepaque(San Pedro)</button>
                    </div>
                    <div id="twitter-wrapper"> 
                        <iframe width="640" height="360" src="//www.youtube.com/embed/0L7jL0rJA00?feature=player_detailpage" frameborder="0" allowfullscreen></iframe>
