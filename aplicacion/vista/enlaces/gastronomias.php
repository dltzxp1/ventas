                ...
                <div id="myCarousel" class="carousel slide">
                    ...
                    <div class="carousel-inner" align="center"> 
                        <div class="item active">
                            ...
                            echo "<img class='FotoView' src='../../modelo/dao/verImgGas.php?pr_id=" . $arrGastronomia[0]->pr_id . "&ca_id=" . $arrGastronomia[0]->ca_id . "&cat_id=" . $arrGastronomia[0]->cat_id . "&si_id=" . $arrGastronomia[0]->si_id . "&ga_id=" . $arrGastronomia[0]->ga_id . "'/>  ";
                            ?>
                        ...
                        for ($r = 0; $r < count($arrGastronomia); $r++) {
                            ...
                            <div class="item">
                                <?php
                                echo "<td> <img class='FotoView' src='../../modelo/dao/verImgGas.php?pr_id=" . $arrGastronomia[$r]->pr_id . "&ca_id=" . $arrGastronomia[$r]->ca_id . "&cat_id=" . $arrGastronomia[$r]->cat_id . "&si_id=" . $arrGastronomia[$r]->si_id . "&ga_id=" . $arrGastronomia[$r]->ga_id . "'/>  </td>";
                                ?> 
                                <div class="carousel-caption">
                                    <h4>
                                        <?php
